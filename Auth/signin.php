...
<!-- Mirrored from techzaa.in/larkon/admin/auth-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Nov 2025 04:19:48 GMT -->
<head>
     <!-- Title Meta -->
     <meta charset="utf-8" />
                                   ...
                                   <div class="d-flex flex-column h-100 justify-content-center">
                                        <div class="auth-logo mb-4">
                                             <a href="index.html" class="logo-dark">
                                                  <img src="../assets/images/BKLogo.png" height="50" alt="logo dark">
                                             </a>
                                        ...
                                        <p class="text-center" style="color: #4CAF7C;">Don't have an account? <a href="auth-signup.html" class="text-dark fw-bold ms-1">Sign Up</a></p>
                                   </div>
                              </div>
                         </div>
                    </div>
