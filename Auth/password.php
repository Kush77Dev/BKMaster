...
<!-- Mirrored from techzaa.in/larkon/admin/auth-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Nov 2025 04:20:12 GMT -->
<head>
     <!-- Title Meta -->
     <meta charset="utf-8" />
                         ...
                         <div class="row justify-content-center h-100">
                              <div class="col-lg-6 py-lg-5">
                                   <div class="d-flex flex-column h-100 justify-content-center">
                                        ...
                                        <p class="mt-5 text-center" style="color: #4CAF7C;">Back to<a href="auth-signin.html" class="text-dark fw-bold ms-1">Sign In</a></p>
                                   </div>
                              </div>
                         </div>
                    </div>
