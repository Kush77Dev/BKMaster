    ...
    <div class="main-nav">
               ...
               <div class="logo-box">
                    <a href="/Index.php" class="logo-dark">
                         <img src="../assets/images/BKLogo.png" class="logo-sm" alt="logo sm">
                         <img src="../assets/images/BKLogo.png" class="logo-lg" alt="logo dark">
                         <!-- <h2>BKMASTER</h2> -->
                    </a>

                    <a href="/Index.php" class="logo-light">
                         <img src="../assets/images/BKLogo.png" class="logo-sm" alt="logo sm">
                         <img src="../assets/images/BKLogo.png" class="logo-lg" alt="logo dark" style="height: 50px; width: 50px; margin-left: 30px;">
                         <!-- <span class="h4" style="color: green;">BKMASTER</span> -->
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                              ...
                              <div class="collapse" id="sidebarProducts">
                                   <ul class="nav sub-navbar-nav">
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="/product/list-product.php">List</a>
                                        </li>
                                        <li class="sub-nav-item">
                                        ...
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="/product/add-product.php">Create</a>
                                        </li>
                                   </ul>
                              </div>
                         </li>
                         ...
                         <li class="nav-item">
                              ...
                              <div class="collapse" id="sidebarCategory">
                                   <ul class="nav sub-navbar-nav">
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="/category/list-category.php">List</a>
                                        </li>                         
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="category-edit.html">Edit</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="/category/add-category.php">Create</a>
                                        </li>
                                   </ul>
                              </div>
                         </li>
                         ...
                         <li class="nav-item">
                              ...
                              <div class="collapse" id="sidebarOrders">
                                   <ul class="nav sub-navbar-nav">
                                        ...
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="/order/list-order.php">List</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="/order/detail-order.php">Details</a>
                                        </li>
                                        <li class="sub-nav-item">
                         ...
                         <li class="nav-item">
                              ...
                              <div class="collapse" id="sidebarCustomers">
                                   <ul class="nav sub-navbar-nav">
                                        ...
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="/customers/list-customer.php">List</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="/customers/detail-customer.php">Details</a>
                                        </li>
                                   </ul>
                              </div>
                         </li>
                         ...
                         <li class="nav-item">
                              ...
                              <div class="collapse" id="sidebarCoupons">
                                   <ul class="nav sub-navbar-nav">
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="/coupens/list-coupen.php">List</a>
                                        </li>
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="/coupens/add-coupen.php">Add</a>
                                        </li>
                                   </ul>
                              </div>
                         </li>
